    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold">{selectedCorridor.name}</h1>
            <p className="text-muted-foreground mt-1">Detailed corridor insights and analytics</p>
          </div>
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-sm text-muted-foreground">Current Score</p>
              <p className="text-3xl font-bold">{selectedCorridor.score}</p>
            </div>
            <Badge className={`${riskColor} text-lg px-4 py-2`}>
